...
from django.views.generic import authentication

"""
from django.views.generic import View　を入れる？ djangoのbase.pyをas_viewで呼び出す？であっているか？
↑のimportのView部分は、引数のauthentication.BaseAuthenticationでいい？
DRFのfromとは違うっぽい
"""
...
if not firebase_admin._apps:
    cred = credentials.Certificate(api_settings.FIREBASE_SERVICE_ACCOUNT_KEY)
...
class BaseFirebaseAuthentication(authentication.BaseAuthentication):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(BaseFirebaseAuthentication, self).dispatch(request, *args, **kwargs)
...
class FirebaseAuthentication(BaseFirebaseAuthentication):
    ...
    @method_decorator(csrf_exempt)
    def dispatch(self, request, *args, **kwargs):
        return super(FirebaseAuthentication, self).dispatch(request, *args, **kwargs)
