...
DEFAULTS = {
    ...
    'FIREBASE_SERVICE_ACCOUNT_KEY': '/Users/nishiyamashota/myproject/myprojectvenv/lib/python3.8/site-packages/adocare-fb017-firebase-adminsdk-e1m0n-dabf56ec30.json',
